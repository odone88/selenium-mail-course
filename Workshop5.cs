...
namespace EndToEndMailCourse._05
{
    ...
    public class Workshop05Tests
    {
        ...
        public void ShouldSelectAnswers()
        {
            ...
            var selectQualityElement = new SelectElement(qualityElement);
            selectQualityElement.SelectByIndex(2);

            var selectSupportElement = new SelectElement(supportElement);
            selectSupportElement.SelectByText("Poor");

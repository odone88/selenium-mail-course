...
namespace EndToEndMailCourse._03
{
    ...
    public class Workshop03Tests
    {
        ...
        public void ShouldCheckSelectedBookName()
        {
            ...
            #region TEST CODE
            book = driver.FindElementByCssSelector("body > div > div:nth-child(2) > div > div > ul > li.list-group-item.book.selected > h4:nth-child(1)");
            #endregion
        ...
        public void ShouldCheckNumberOfBooks()
        {
            ...
            books = driver.FindElementsByClassName("book");
            #endregion

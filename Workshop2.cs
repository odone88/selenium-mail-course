...
namespace EndToEndMailCourse._02
{
    ...
    public class Workshop02Tests
    {
        ...
        public void ShouldTestWorkshop2Page()
        {
            ...
            #region TEST CODE
            var taskName = driver.FindElementById("taskNameInput");
            taskName.SendKeys(name);
            taskName.SendKeys(Keys.Enter);

            var showDetails = driver.FindElementById("showDetailsButton");
            showDetails.Click();


            var commentInput = driver.FindElementById("commentInput");
